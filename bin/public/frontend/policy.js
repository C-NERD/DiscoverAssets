...
function applyEvents_11010073(n_11010075) {
    ...
    L1: do {
      var i_11010089 = 0;
      var colontmp__11545287 = 0;
      colontmp__11545287 = (n_11010075.events).length;
      var i_11545288 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11545288 < colontmp__11545287)) break L3;
            i_11010089 = i_11545288;
            ...
            i_11545288 = addInt(i_11545288, 1);
          }
      } while(false);
    } while(false);
...
function applyStyle_10455628(n_10455630, s_10455631) {
    ...
    L1: do {
      var i_10455664 = 0;
      var colontmp__11545298 = 0;
      colontmp__11545298 = subInt(s_10455631.length, 1);
      var res_11545299 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_11545299 <= colontmp__11545298)) break L3;
            i_10455664 = res_11545299;
            n_10455630.style[s_10455631[i_10455664]] = s_10455631[addInt(i_10455664, 1)];
            res_11545299 = addInt(res_11545299, 2);
          }
      } while(false);
    } while(false);
  ...
  BeforeRet: do {
    ...
    break BeforeRet;
      ...
      L1: do {
        ...
        L2: do {
          var i_11545256 = 0;
          var colontmp__11545257 = 0;
          colontmp__11545257 = (n_11010156.kids).length;
          var i_11545258 = 0;
          L3: do {
              L4: while (true) {
              if (!(i_11545258 < colontmp__11545257)) break L4;
                i_11545256 = i_11545258;
                k_11135016 = n_11010156.kids[chckIndx(i_11545256, 0, (n_11010156.kids).length-1)];
                result_11010159.appendChild(toDom_11010154(k_11135016, useAttachedNode_11010157, kxi_11010158));
                i_11545258 = addInt(i_11545258, 1);
              }
          } while(false);
        } while(false);
      } while(false);
    ...
    L5: do {
      ...
      L6: do {
        var i_11545269 = 0;
        var colontmp__11545270 = 0;
        colontmp__11545270 = subInt((n_11010156.attrs).length, 2);
        var res_11545271 = 0;
        L7: do {
            L8: while (true) {
            if (!(res_11545271 <= colontmp__11545270)) break L8;
              i_11545269 = res_11545271;
              k_11150001 = n_11010156.attrs[chckIndx(i_11545269, 0, (n_11010156.attrs).length-1)];
              v_11150002 = n_11010156.attrs[chckIndx(addInt(i_11545269, 1), 0, (n_11010156.attrs).length-1)];
              if (!((v_11150002 == null))) {
              result_11010159.setAttribute(k_11150001, v_11150002);
              }
              
              res_11545271 = addInt(res_11545271, 2);
            }
        } while(false);
      } while(false);
    } while(false);
...
function same_11160072(n_11160074, e_11160075, nesting_11160076) {
  ...
  BeforeRet: do {
    ...
    L3: do {
      var i_11175024 = 0;
      var colontmp__11545305 = 0;
      colontmp__11545305 = len_10550014(n_11160074);
      var i_11545306 = 0;
      L4: do {
          L5: while (true) {
          if (!(i_11545306 < colontmp__11545305)) break L5;
            i_11175024 = i_11545306;
            if (!(same_11160072(HEX5BHEX5D_10550036(n_11160074, i_11175024), e_11160075.childNodes[i_11175024], addInt(nesting_11160076, 1)))) {
            result_11160078 = false;
            break BeforeRet;
            }
            
            i_11545306 = addInt(i_11545306, 1);
          }
      } while(false);
    } while(false);
    }
...
function eq_10420229(a_10420231, b_10420232) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_10425083 = 0;
      var colontmp__11545345 = 0;
      colontmp__11545345 = a_10420231.length;
      var i_11545346 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11545346 < colontmp__11545345)) break L3;
            i_10425083 = i_11545346;
            if (!((a_10420231[i_10425083] == b_10420232[i_10425083]))) {
            result_10420233 = false;
            break BeforeRet;
            }
            
            i_11545346 = addInt(i_11545346, 1);
          }
      } while(false);
    } while(false);
    result_10420233 = true;
...
function sameAttrs_10561079(a_10561081, b_10561082) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_10561106 = 0;
      var colontmp__11545349 = 0;
      colontmp__11545349 = (a_10561081.attrs).length;
      var i_11545350 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11545350 < colontmp__11545349)) break L3;
            i_10561106 = i_11545350;
            ...
            i_11545350 = addInt(i_11545350, 1);
          }
      } while(false);
    } while(false);
    }
...
function eq_11175214(a_11175216, b_11175217, recursive_11175218) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_11205008 = 0;
      var colontmp__11545337 = 0;
      colontmp__11545337 = len_10550014(a_11175216);
      var i_11545338 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11545338 < colontmp__11545337)) break L3;
            i_11205008 = i_11545338;
            if ((eq_11175214(HEX5BHEX5D_10550036(a_11175216, i_11205008), HEX5BHEX5D_10550036(b_11175217, i_11205008), recursive_11175218) == 1)) {
            result_11175219 = 1;
            break BeforeRet;
            }
            
            i_11545338 = addInt(i_11545338, 1);
          }
      } while(false);
    } while(false);
    }
    ...
    L6: do {
      var i_11230008 = 0;
      var colontmp__11545341 = 0;
      colontmp__11545341 = len_10550014(a_11175216);
      var i_11545342 = 0;
      L7: do {
          L8: while (true) {
          if (!(i_11545342 < colontmp__11545341)) break L8;
            i_11230008 = i_11545342;
            if (!((eq_11175214(HEX5BHEX5D_10550036(a_11175216, i_11230008), HEX5BHEX5D_10550036(b_11175217, i_11230008), true) == 3))) {
            result_11175219 = 1;
            break BeforeRet;
            }
            
            i_11545342 = addInt(i_11545342, 1);
          }
      } while(false);
    } while(false);
    }
...
function updateAttributes_11245052(newNode_11245054, oldNode_11245055) {
    ...
    L1: do {
      ...
      L2: do {
        var i_11545355 = 0;
        var colontmp__11545356 = 0;
        colontmp__11545356 = subInt((oldNode_11245055.attrs).length, 2);
        var res_11545357 = 0;
        L3: do {
            L4: while (true) {
            if (!(res_11545357 <= colontmp__11545356)) break L4;
              i_11545355 = res_11545357;
              k_11250009 = oldNode_11245055.attrs[chckIndx(i_11545355, 0, (oldNode_11245055.attrs).length-1)];
              __11250010 = oldNode_11245055.attrs[chckIndx(addInt(i_11545355, 1), 0, (oldNode_11245055.attrs).length-1)];
              oldNode_11245055.dom.removeAttribute(k_11250009);
              res_11545357 = addInt(res_11545357, 2);
            }
        } while(false);
      } while(false);
    } while(false);
    L5: do {
      ...
      L6: do {
        var i_11545363 = 0;
        var colontmp__11545364 = 0;
        colontmp__11545364 = subInt((newNode_11245054.attrs).length, 2);
        var res_11545365 = 0;
        L7: do {
            L8: while (true) {
            if (!(res_11545365 <= colontmp__11545364)) break L8;
              i_11545363 = res_11545365;
              k_11250011 = newNode_11245054.attrs[chckIndx(i_11545363, 0, (newNode_11245054.attrs).length-1)];
              v_11250012 = newNode_11245054.attrs[chckIndx(addInt(i_11545363, 1), 0, (newNode_11245054.attrs).length-1)];
              if (!((v_11250012 == null))) {
              oldNode_11245055.dom.setAttribute(k_11250011, v_11250012);
              }
              
              res_11545365 = addInt(res_11545365, 2);
            }
        } while(false);
      } while(false);
    } while(false);
...
function removeAllEventHandlers_10897436(d_10897438) {
    ...
    L1: do {
      var i_10900041 = 0;
      var colontmp__11545370 = 0;
      colontmp__11545370 = d_10897438.karaxEvents.length;
      var i_11545371 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11545371 < colontmp__11545370)) break L3;
            i_10900041 = i_11545371;
            d_10897438.removeEventListener(d_10897438.karaxEvents[i_10900041]["Field0"], d_10897438.karaxEvents[i_10900041]["Field1"]);
            i_11545371 = addInt(i_11545371, 1);
          }
      } while(false);
    } while(false);
    }
...
function diff_11310215(newNode_11310217, oldNode_11310218, parent_11310219, current_11310220, kxi_11310221) {
  ...
  BeforeRet: do {
    ...
    case 2:
      ...
      L7: do {
        var i_11340024 = 0;
        var colontmp__11545312 = 0;
        colontmp__11545312 = subInt(pos_11340018, 1);
        var res_11545313 = commonPrefix_11330202;
        L8: do {
            L9: while (true) {
            if (!(res_11545313 <= colontmp__11545312)) break L9;
              i_11340024 = res_11545313;
              ...
              res_11545313 = addInt(res_11545313, 1);
            }
        } while(false);
      } while(false);
      ...
      L10: do {
        var i_11340030 = 0;
        var res_11545319 = pos_11340018;
        L11: do {
            L12: while (true) {
            if (!(res_11545319 <= newPos_11330215)) break L12;
              i_11340030 = res_11545319;
              addPatch_11260414(kxi_11310221, 2, current_11310220, null, HEX5BHEX5D_10550036(newNode_11310217, i_11340030), null);
              res_11545319 = addInt(res_11545319, 1);
            }
        } while(false);
      } while(false);
      }
        ...
        L13: do {
          var i_11340037 = 0;
          var res_11545325 = pos_11340018;
          L14: do {
              L15: while (true) {
              if (!(res_11545325 <= newPos_11330215)) break L15;
                i_11340037 = res_11545325;
                addPatch_11260414(kxi_11310221, 3, current_11310220, before_11340031, HEX5BHEX5D_10550036(newNode_11310217, i_11340037), null);
                res_11545325 = addInt(res_11545325, 1);
              }
          } while(false);
        } while(false);
      }
      ...
      L16: do {
        var i_11340043 = 0;
        var res_11545331 = pos_11340018;
        L17: do {
            L18: while (true) {
            if (!(res_11545331 <= oldPos_11330214)) break L18;
              i_11340043 = res_11545331;
              ...
              res_11545331 = addInt(res_11545331, 1);
            }
        } while(false);
      } while(false);
      break;
...
function moveDom_11270048(dest_11270050, src_11270051) {
    ...
    L1: do {
      var i_11285208 = 0;
      var colontmp__11545382 = 0;
      colontmp__11545382 = len_10550014(dest_11270050);
      var i_11545383 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11545383 < colontmp__11545382)) break L3;
            i_11285208 = i_11545383;
            moveDom_11270048(HEX5BHEX5D_10550036(dest_11270050, i_11285208), HEX5BHEX5D_10550036(src_11270051, i_11285208));
            i_11545383 = addInt(i_11545383, 1);
          }
      } while(false);
    } while(false);
...
function applyPatch_11285222(kxi_11285224) {
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11545376 < kxi_11285224.patchLen)) break L3;
            i_11285232 = i_11545376;
            ...
            i_11545376 = addInt(i_11545376, 1);
          }
      } while(false);
    } while(false);
    ...
    L4: do {
      ...
      L5: do {
          L6: while (true) {
          if (!(i_11545379 < kxi_11285224.patchLenV)) break L6;
            i_11295013 = i_11545379;
            ...
            i_11545379 = addInt(i_11545379, 1);
          }
      } while(false);
    } while(false);
...
function tree_10560445(kind_10560447, kids_10560449) {
  var result_10560450 = null;
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11545407 < (kids_10560449).length)) break L3;
            k_10560483 = kids_10560449; k_10560483_Idx = chckIndx(i_11545407, 0, (kids_10560449).length-1);
            add_10550072(result_10560450, k_10560483[k_10560483_Idx]);
            i_11545407 = addInt(i_11545407, 1);
          }
      } while(false);
    } while(false);
...
function menu_11541043(e_11541045, n_11541046) {
    var line1_11541047 = document.getElementById("line1");
    var line2_11541048 = document.getElementById("line2");
    var line3_11541049 = document.getElementById("line3");
    var menu_11541050 = document.getElementById("menu");
    if ((menu_11541050.className == "menu1")) {
    line1_11541047.className = "line11";
    line2_11541048.className = "line21";
    line3_11541049.className = "line31";
    menu_11541050.className = "menu2";
    }
    else {
    if ((menu_11541050.className == "menu2")) {
    line1_11541047.className = "";
    line2_11541048.className = "";
    line3_11541049.className = "";
    menu_11541050.className = "menu1";
    }
    }
...
function setAttr_10500105(n_10500107, key_10500108, val_10500109) {
  BeforeRet: do {
    ...
    n_10500107.attrs = nimCopy(null, [key_10500108, val_10500109], NTI10500125);
      ...
      L1: do {
        var i_10500138 = 0;
        var colontmp__11545411 = 0;
        colontmp__11545411 = subInt((n_10500107.attrs).length, 2);
        var res_11545412 = 0;
        L2: do {
            L3: while (true) {
            if (!(res_11545412 <= colontmp__11545411)) break L3;
              i_10500138 = res_11545412;
              ...
              res_11545412 = addInt(res_11545412, 2);
            }
        } while(false);
      } while(false);
...
function home_11541064() {
    function clean_11541067() {
      var result_11541074 = {Field0: null, Field1: null, Field2: null, Field3: null};

        var youtube_11541075 = document.getElementById("youtubelink");
        var twitter_11541076 = document.getElementById("twitterlink");
        var mail_11541077 = document.getElementById("maillink");
        var policy_11541078 = document.getElementById("policyinfo");
        var logo_11541079 = document.getElementById("logoname");
        var notification_11541080 = document.getElementById("notifyinfo");
        var notify_11541081 = document.getElementById("notifybool");
        var parent_11541082 = logo_11541079.parentNode;
        result_11541074.Field0 = youtube_11541075.value;
        result_11541074.Field1 = twitter_11541076.value;
        result_11541074.Field2 = mail_11541077.value;
        result_11541074.Field3 = parseMarkdown(policy_11541078.value);
        parent_11541082.removeChild(logo_11541079);
        parent_11541082.removeChild(youtube_11541075);
        parent_11541082.removeChild(twitter_11541076);
        parent_11541082.removeChild(mail_11541077);
        parent_11541082.removeChild(policy_11541078);
        parent_11541082.removeChild(notification_11541080);
        parent_11541082.removeChild(notify_11541081);

      return result_11541074;

    }
    function HEX3Aanonymous_11541097() {
        var policy_11541099 = document.getElementById("policy");
        policy_11541099.innerHTML = info_11541096.Field3;

      
    }

  var result_11541066 = null;

    var info_11541096 = clean_11541067();
    var _ = setTimeout(HEX3Aanonymous_11541097, 1000);
    var tmp_11541150 = tree_10560445(30, []);
    tmp_11541150.id = "canvas";
    var tmp_11541156 = tree_10560445(18, []);
    tmp_11541156.id = "navbar";
    var tmp_11541157 = tree_10560445(43, []);
    tmp_11541157.id = "burger";
    addEventHandler_11460118(tmp_11541157, 0, menu_11541043, kxi_10897284[0]);
    var tmp_11541158 = tree_10560445(43, []);
    tmp_11541158.id = "line1";
    tmp_11541158.class = "";
    add_10550072(tmp_11541157, tmp_11541158);
    var tmp_11541159 = tree_10560445(43, []);
    tmp_11541159.id = "line2";
    tmp_11541159.class = "";
    add_10550072(tmp_11541157, tmp_11541159);
    var tmp_11541160 = tree_10560445(43, []);
    tmp_11541160.id = "line3";
    tmp_11541160.class = "";
    add_10550072(tmp_11541157, tmp_11541160);
    add_10550072(tmp_11541156, tmp_11541157);
    add_10550072(tmp_11541150, tmp_11541156);
    var tmp_11541161 = tree_10560445(43, []);
    tmp_11541161.id = "menu";
    tmp_11541161.class = "menu1";
    var tmp_11541162 = tree_10560445(43, []);
    tmp_11541162.id = "legal";
    var tmp_11541163 = tree_10560445(44, []);
    setAttr_10500105(tmp_11541163, "href", "/");
    add_10550072(tmp_11541163, text_10560582(makeNimstrLit("Home")));
    add_10550072(tmp_11541162, tmp_11541163);
    add_10550072(tmp_11541161, tmp_11541162);
    var tmp_11541164 = tree_10560445(43, []);
    tmp_11541164.id = "social";
    var tmp_11541165 = tree_10560445(44, []);
    setAttr_10500105(tmp_11541165, "href", toJSStr(cstrToNimstr(info_11541096.Field0)));
    var tmp_11541166 = tree_10560445(31, []);
    add_10550072(tmp_11541166, text_10560582(makeNimstrLit("Youtube")));
    add_10550072(tmp_11541165, tmp_11541166);
    var tmp_11541167 = tree_10560445(43, []);
    tmp_11541167.id = "youtube";
    tmp_11541167.class = "social";
    add_10550072(tmp_11541165, tmp_11541167);
    add_10550072(tmp_11541164, tmp_11541165);
    var tmp_11541168 = tree_10560445(44, []);
    setAttr_10500105(tmp_11541168, "href", toJSStr(cstrToNimstr(info_11541096.Field1)));
    var tmp_11541169 = tree_10560445(31, []);
    add_10550072(tmp_11541169, text_10560582(makeNimstrLit("Twitter")));
    add_10550072(tmp_11541168, tmp_11541169);
    var tmp_11541170 = tree_10560445(43, []);
    tmp_11541170.id = "twitter";
    tmp_11541170.class = "social";
    add_10550072(tmp_11541168, tmp_11541170);
    add_10550072(tmp_11541164, tmp_11541168);
    var tmp_11541171 = tree_10560445(44, []);
    setAttr_10500105(tmp_11541171, "href", toJSStr(cstrToNimstr(info_11541096.Field2)));
    var tmp_11541172 = tree_10560445(31, []);
    add_10550072(tmp_11541172, text_10560582(makeNimstrLit("Contact me via gmail")));
    add_10550072(tmp_11541171, tmp_11541172);
    var tmp_11541173 = tree_10560445(43, []);
    tmp_11541173.id = "gmail";
    tmp_11541173.class = "social";
    add_10550072(tmp_11541171, tmp_11541173);
    add_10550072(tmp_11541164, tmp_11541171);
    add_10550072(tmp_11541161, tmp_11541164);
    add_10550072(tmp_11541150, tmp_11541161);
    var tmp_11541174 = tree_10560445(43, []);
    tmp_11541174.id = "policy";
    add_10550072(tmp_11541150, tmp_11541174);
    result_11541066 = tmp_11541150;

  return result_11541066;

}
setRenderer_11455238(home_11541064, "ROOT", null);
